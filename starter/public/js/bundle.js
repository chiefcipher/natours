...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY2hpZWZjaXBoZXIiLCJhIjoiY2t4bHVpMmZoMWs2OTJ3dWI3ZnM3dG1qNSJ9.vT1pLDVvVIzncKD5aGqA9g';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/chiefcipher/cl8zwwkjh00td14obkw5mhz60',
    // style URL
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // extend mapbound to include currentloction
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Login sucessfully'); // navigate to home page refreshing the page
...
var stripe = Stripe('pk_test_51LuJ2vFIDmjnz4MHnihmT0doQARDGsUhc2FcDmYJw37uq3uv4eMxPAQwXfjMRJxTakKAbxH8ZQm1DbzGdKVcUOZS00UVTqYUZc');
...
if (userDataForm) {
  console.log('enter usr data form ');
